...
This document contains Python scripts for processing design assets.
...
def export_ios(source_img, output_dir):
    ...
    # iOS doesn't support transparent backgrounds
...
def main():
    ...
    if img.size != (1024, 1024):
        print(f"\n⚠️  Resizing source image from {img.size} to 1024x1024")
