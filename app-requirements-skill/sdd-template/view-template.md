...
## Viewpoint
➥ Identify the viewpoint of which this view is an instance.

## Representation
➥ The design view representation per the viewpoint selected, e.g., natural language description or a diagram or a combination thereof.
