---
name: arcana-angular-developer-skill
...
2. **Duplicate its ENTIRE file set** (model, validator, service interface + impl, repository interface + impl, DTO, mapper, mock repository, provider binding, ViewModel, component, NavGraph methods, route, specs) 1:1, keeping every layer.
