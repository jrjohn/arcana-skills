...
> **⚠️ 在標記 04-validation 為 completed 之前，必須執行以下命令！**
...
| 項目 | 要求 |
|------|------|
| **index.html** | 存在 + 模組數正確 + 覆蓋率顯示 |
| **device-preview.html** | 存在 + 側邊欄畫面數正確 |
| **所有 SCR-*.html** | 0 個 alert() + 0 個空 onclick |
...
**注意**: 只有在 100% 覆蓋時且 post-generation-gate.js PASSED 才能進入下一節點！
