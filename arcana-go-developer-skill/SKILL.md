---
name: arcana-go-developer-skill
...
2. **Duplicate its ENTIRE file set** (domain entity, migration, DTO + mapper, DAO interface + impl, repository interface + impl, service interface + impl, HTTP handler + routes, gRPC proto + server impl, DI wiring, mock data, and unit tests per layer) 1:1, keeping every layer.
